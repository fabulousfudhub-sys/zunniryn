...
export const NIGERIA_STATES: StateData[] = [
  ...
  { state: "Adamawa", lgas: ["Demsa","Fufore","Ganye","Gayuk","Gombi","Grie","Hong","Jada","Lamurde","Madagali","Maiha","Mayo Belwa","Michika","Mubi North","Mubi South","Numan","Shelleng","Song","Toungo","Yola North","Yola South"] },
...
export function getLGAs(state: string): string[] {
  return NIGERIA_STATES.find((s) => s.state === state)?.lgas ?? [];
}
